...
Layout Best Practices | The code adheres to all of the following best practices: 1. Text sizes are defined in sp 2. Lengths are defined in dp 3. Padding and margin is used appropriately, such that the views are not crammed up against each other.
